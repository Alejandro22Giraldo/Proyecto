 ...
 * @author 312A-13
 */
public class Fomrulario extends javax.swing.JFrame {

    /**
     * Creates new form Fomrulario
     */
    public Fomrulario() {
        initComponents();
    }
...
txthipotenusa.setText(String.valueOf(hipotenusa));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fomrulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fomrulario().setVisible(true);
            }
        });
    }
